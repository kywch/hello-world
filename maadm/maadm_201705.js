...
var choice_instruct_page = {
    ...
    text: "<div class = centerbox>" +
        ...
        "are the points at stake for the easy and hard problems, respectively. " +
        "You should choose what type of problem you want to solve " +
        ...
        "<p class = block-text><font color=red>We will NOT let you know immediately whether " +
        "you got the problem correct or not. Instead, you will be informed of the " +
        "total points you earned at the end of each block of 20 trials.</font></p>" +
...
for (var ii = 0; ii < option_practice.length; ii++) {
    ...
    var feedback_page = {
        ...
        timing_post_trial: 1000, // give a 1-sec break
        text: function() {
            if (option_practice.length - curr_prac_choice > 1) {
                return "<div class = centerbox><p class = center-block-text>You have " +
                    (option_practice.length - curr_prac_choice - 1).toString() + " trials left.</p>" +
                    "<p class = center-block-text>Press <strong>Enter</strong> or " +
                    "<strong>Space bar</strong> key to start the next trial.</p></div>";
            } else {
                return "<div class = centerbox><p class = center-block-text>You have no trials left.</p>" +
                    "<p class = center-block-text>Press <strong>Enter</strong> or " +
                    "<strong>Space bar</strong> key to proceed.</p></div>";
            }
        },
        data: function() {
            if (curr_correct) {
...
function generate_main_block(block_count) {
    ...
    var start_main_block_page = {
        ...
        text: function() {
            ...
            return "<div class = centerbox><p class = block-text>" +
                ...
                "<p class = block-text>Each choice must be made <b>within 3 seconds</b>, " +
                "otherwise you will be automatically directed to the Easy problem with 1 point at stake.</p>" +
                "<p class = block-text>We will NOT let you know immediately whether " +
                "you got the problem correct or not. Instead, you will be informed of the " +
                "total points you earned at the end of each block of 20 trials.</p>" +
                "<p class = block-text>The maximum points you can earn in this block is <b>80</b> points. </p>" +
                "<p class = block-text>Press &quot;<b>o</b>&quot; key to begin a trial.</p>" +
                "</div>";
        },
    ...
    for (var ii = 0; ii < option_this.length; ii++) {
        ...
        var feedback_page = {
            ...
            timing_post_trial: 1000, // give a 1-sec break
            text: function() {
                if (option_this.length - curr_main_hard > 1) {
                    return "<div class = centerbox><p class = center-block-text>You have " +
                        (option_this.length - curr_main_hard - 1).toString() + " trials left.</p>" +
                        "<p class = center-block-text>Press <strong>Enter</strong> or " +
                        "<strong>Space bar</strong> key to start the next trial.</p></div>";
                } else {
                    return "<div class = centerbox><p class = center-block-text>You have no trials left.</p>" +
